...
BrowserDetect = function() {
    BrowserDetect.browser =
        BrowserDetect.searchString(BrowserDetect.DATA_BROWSER) ||
        "Unknown browser";
    BrowserDetect.version =
        ...
        "Unknown version";
    BrowserDetect.os =
        BrowserDetect.searchString(BrowserDetect.DATA_OS) || "Unknown OS";
};
...
BrowserDetect.searchString = function(data) {
    for (var index = 0; index < data.length; index++) {
        ...
        BrowserDetect.versionSearchString =
...
BrowserDetect.searchVersion = function(dataString) {
    ...
    return parseFloat(
        dataString.substring(
            index + BrowserDetect.versionSearchString.length + 1
        )
    );
};
