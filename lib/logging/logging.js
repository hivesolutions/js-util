...
Logging.debug = function(messageValue) {
    Logging.getLogger(Logging.constants.DEFAULT_LOGGER_NAME).debug(
        messageValue
    );
};
...
Logging.error = function(messageValue) {
    Logging.getLogger(Logging.constants.DEFAULT_LOGGER_NAME).error(
        messageValue
    );
};

Logging.critical = function(messageValue) {
    Logging.getLogger(Logging.constants.DEFAULT_LOGGER_NAME).critical(
        messageValue
    );
};
...
Logging.LevelsMap[Logging.constants.CRITICAL] =
    Logging.constants.CRITICAL_VALUE;
...
Logging.LevelsMap[Logging.constants.CRITICAL_VALUE] =
    Logging.constants.CRITICAL;
...
Logging.Logger = function(loggerName, level, handlers) {
    ...
    this.level =
        typeof level === "undefined" ? Logging.constants.DEFAULT_LEVEL : level;
